...
Use the source-management commands rather than editing YAML when possible. They normalize tags, validate category references, detect duplicates, verify providers, and write files atomically.
